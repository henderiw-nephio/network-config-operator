module github.com/henderiw-nephio/network-config-operator
...
require (
	...
	github.com/nephio-project/api v0.0.0-20230613215034-5be08f75eb2e
	github.com/nephio-project/nephio/controllers/pkg v0.0.0-20230614061735-4825e7bb8773
